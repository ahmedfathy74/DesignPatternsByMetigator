namespace BuilderDesignPattern.After
{
    ...
    public class PropertyBuilder
    {
        ...
        /* if i want to use this approach to set every field in the object i will make like te next function foreach property in the object but i will use method chaining to set whatever i want containously */
