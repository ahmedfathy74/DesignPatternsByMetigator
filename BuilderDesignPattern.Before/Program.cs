namespace BuilderDesignPattern.Before
{
    ...
    class Property // عقار
    {
        ...
        public Property(string address, TransactionType transactionType, PropertyType propertyType,
            int totalBedrooms, double floorArea, decimal price, int totalBathrooms, int totalStoreys,
            int yearBuilt, bool hasSwimmingPool, bool hasWifi, 
        ...
        public Property(string address, TransactionType transactionType,
